...
struct iptmpl {
    QIRD  * I650;
    struct vcs_globals_t * I651;
    void * I653;
    UP  I654;
    UP  I655;
    struct iptmpl * I646[2];
};
typedef unsigned long long FileOffset;
typedef struct _hsimPeriodL {
    char  I817[256];
    struct _hsimPeriodL * I783;
} HsimPeriodL;
typedef struct {
    U   I819[2];
    U  I820 :1;
...
struct dummyq_struct {
    ...
    struct futq * I969;
    struct futq * I970;
    struct sched_table * I971;
    struct millenium * I973;
    EBLK  * I975;
    EBLK  * I976;
    EBLK  * I977;
    EBLK  * I978;
...
extern "C" {
#endif
void  hsM_0_0 (UB  * pcode, vec32  * I855, U  I791);
void  hsM_1_0 (UB  * pcode, vec32  * I855, U  I791);
void  hsM_2_0 (UB  * pcode, vec32  * I855, U  I791);
void  hsM_3_0 (UB  * pcode, vec32  * I855, U  I791);
void  hsM_4_0 (UB  * pcode, vec32  * I855, U  I791);
void  hsM_5_0 (UB  * pcode, vec32  * I855, U  I791);
void  hsM_6_0 (UB  * pcode, scalar  val);
void  hsM_7_0 (UB  * pcode, vec32  * I855, U  I791);
